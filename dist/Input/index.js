...
function Input(props) {
    ...
    let inputClassName = [
        "w-full appearance-none font-medium py-2 px-5 rounded-full border border-soft-gray focus:border-purple focus:outline-none valid:disabled:bg-soft-gray",
    ...
    if (props.type === "file" && isFileAcceptImageOnly) {
        ...
        RenderInputImage = ((0, jsx_runtime_1.jsxs)("div", { className: "w-28 h-28 relative", children: [blobImage ? ((0, jsx_runtime_1.jsx)("span", { className: "flex rounded-full overflow-hidden w-full h-full", children: (0, jsx_runtime_1.jsx)("img", { src: blobImage, className: "object-cover" }) })) : ((0, jsx_runtime_1.jsxs)("svg", { viewBox: "0 0 104 104", fill: "none", preserveAspectRatio: "xMidYMid meet", children: [(0, jsx_runtime_1.jsx)("circle", { cx: "52", cy: "52", r: "50", className: "stroke-soft-gray", "stroke-width": "4" }), (0, jsx_runtime_1.jsx)("circle", { cx: "52", cy: "36", r: "18", className: "stroke-soft-gray", "stroke-width": "4" }), (0, jsx_runtime_1.jsx)("path", { d: "M84.3013 90.5C79.0175 77.8722 66.5447 69 51.9998 69C37.4548 69 24.982 77.8722 19.6982 90.5", className: "stroke-soft-gray", "stroke-width": "4" })] })), (0, jsx_runtime_1.jsx)("label", { htmlFor: props.id, className: "absolute inset-0 cursor-pointer" }), (0, jsx_runtime_1.jsx)("label", { htmlFor: props.id, className: [
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: wrapperClassName.join(" "), children: [props.label && ((0, jsx_runtime_1.jsx)("label", { htmlFor: props.id, className: "mb-1", children: props.label })), (0, jsx_runtime_1.jsxs)("div", { className: "relative", children: [(0, jsx_runtime_1.jsx)("input", { type: props.type, id: props.id, name: props.name, readOnly: props.readOnly, disabled: props.isDisabled || props.isLoading, className: inputClassName.join(" "), placeholder: props.placeholder || "Your Placeholder goes here", onChange: onChange }), RenderInputImage, state === "loading" && ((0, jsx_runtime_1.jsx)("span", { className: [
                            ...
                            "transition-all duration-300 absolute right-0 top-0 bottom-0 z-10 inline-flex items-center justify-center opacity-100 aspect-square ",
                        ].join(" "), children: (0, jsx_runtime_1.jsx)("svg", { viewBox: "0 0 12 8", fill: "none", className: "bg-green rounded-full w-5 h-5 p-1", children: (0, jsx_runtime_1.jsx)("path", { d: "M1.8335 4L4.46508 6.5L10.1668 1.5", className: "stroke-white", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }) }) }))] })] }));
}
